...
<div class="cont">
    <?php
    echo "<form class=\"form-signin\" action=\"alterpasswd.php?user=" . $_GET['user'] . "\" method=\"post\">";
    ?>
        ...
        <br>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" name="cfpassword" id="inputPassword" class="form-control" placeholder="Confirm the Password" required>
        <br>
        <input type="submit" class="btn btn-lg btn-primary btn-block" type="submit" value="Submit">
    </form>
</div>
